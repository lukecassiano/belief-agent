When AI components communicate under uncertainty, naïve information sharing can make systems worse. 
This project studies when communication helps—and when it causes cascading failure.
